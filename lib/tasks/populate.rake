namespace :db do
  ...
  task :populate => :environment do
    ...
    location_address = ["Central Square", "Schulich Building", "Steacie Building", "Glendon Campus", "Osgood Building", "Ross Building", "Scott Library"]
    ...
    type_index = 0
    User.populate User::TYPES.size do |u, id|
      u.user_type = User::TYPES[type_index]
      u.name = "#{Faker::Name.name} #{u.user_type}"
      u.email = Faker::Internet.email
      u.phone = Faker::PhoneNumber.extension
      u.department = %w(History Anthropology CompSci PoliSci Mathematics Philosophy Sociology Physics BioInformatics Biology Chemistry)
      u.office = ["Ross South 54", "Vari Hall 2010", "Vari Hall 1010", "Stong 111", "Stong 123", "Calumet 102", "Calumet 202", "Founders 304", "Winters 210", "Tel 108", "Tel 109", "Winters 300", "BSB 405", "Petrie 324", "Petrie 376"]
    ...
    Course.populate 70..90 do |course, index|
      course.name = ["Physics", "History of Man", "Calculus", "Polictics Of Fools", "Infinite Algebra", "Informatics", "BioChemistry", "Chemistry", "Kinestetics"]
      ...
      Request.populate 1 do |request, requests_counter|
        ...
        Item.populate 1..4 do |item, items_counter|
          ...
          item.metadata_source_id = 1000..1000000
          item.item_type = [Item::TYPE_BOOK,Item::TYPE_EBOOK,Item::TYPE_MULTIMEDIA, Item::TYPE_COURSE_KIT, Item::TYPE_PHOTOCOPY, Item::TYPE_MAP]
        end
      end
