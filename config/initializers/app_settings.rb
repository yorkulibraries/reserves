...
if ActiveRecord::Base.connection.data_source_exists? 'settings'
  ...
  Setting.save_default(:app_maintenance_message, "Reserves Application will be taken down for maintenance from 12pm - 4pm today. We appologize for any inconvenience this may have caused.")
