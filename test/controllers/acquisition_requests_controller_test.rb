...
class AcquisitionRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  should "update an existing acquisition_request" do
    ...
    patch acquisition_request_path(@acquisition_request), params: { acquisition_request: { acquisition_source_type: "NEW" } }
  ...
  should "send acquisition email to bookstore" do
    ...
    assert_enqueued_emails 1 do
      post send_to_acquisitions_acquisition_request_path(arequest), params: { which: AcquisitionRequest::EMAIL_TO_BOOKSTORE }
    end
  ...
  should "send acquisition email to acquisition's department" do
    ...
    assert_enqueued_emails 1 do
      post send_to_acquisitions_acquisition_request_path(arequest), params: { which: AcquisitionRequest::EMAIL_TO_ACQUISITIONS }
    end
  ...
  should "send acquisition email to location's acquisition email address" do
    ...
    assert_enqueued_emails 1 do
      post send_to_acquisitions_acquisition_request_path(arequest), params: { which: AcquisitionRequest::EMAIL_TO_LOCATION }
    end
